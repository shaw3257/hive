...
(() => {
  ...
  var require_board = __commonJS({
    "lib/board.js"(exports, module) {
      function Board2() {
        ...
        this.pieces = {};
        this.pieces.WHITE = Board2.createPieces(Board2.PLAYER_WHITE);
        this.pieces.BLACK = Board2.createPieces(Board2.PLAYER_BLACK);
      ...
      Board2.PLAYER_WHITE = "WHITE";
      Board2.PLAYER_BLACK = "BLACK";
      Board2.FIRST_LOCATION = "0:-1:0";
      Board2.SECOND_LOCATION = "0:1:0";
      Board2.pieceSet = function() {
        return ["QUEEN", "SPIDER", "SPIDER", "BEETLE", "BEETLE", "GRASSHOPPER", "GRASSHOPPER", "GRASSHOPPER", "ANT", "ANT", "ANT"];
      };
      Board2.prototype.whoseTurn = function() {
        return this.turn() % 2 === 0 ? Board2.PLAYER_BLACK : Board2.PLAYER_WHITE;
      };
      Board2.prototype.turn = function() {
        return this.moves.length + 1;
      };
      Board2.prototype.surroundingPieces = function(location, filtered) {
        var _this = this;
        var pieces = Board2.surroundingLocations(location).map(function(neighbor) {
      ...
      Board2.prototype.stackedPieces = function(location) {
        var piece = this.hive[location + ":0"];
        var pieces = [];
        while (piece) {
          pieces.push(piece);
          var newLocation = Board2.MOVEMENTS.UP(piece.location);
          piece = this.hive[newLocation];
        }
        return pieces;
      };
      Board2.prototype.moveableLocations = function(location, distance, visited) {
        var moveableLocations = [];
        var _this = this;
        var distance = distance || 1;
        var visited = visited || {};
        visited[location] = location;
        var possibleLocations = Board2.surroundingLocations(location);
      ...
      Board2.prototype.crawlupableLocations = function(location) {
        var crawlupableLocations = [];
        var locations = Board2.surroundingLocations(location);
        for (var i = 0; i < locations.length; i++) {
          ...
          if (neighborPiece) {
            ...
            while (pinner) {
              var lastLocation = Board2.MOVEMENTS.UP(pinner.location);
      ...
      Board2.prototype.crawlableLocations = function(location) {
        var crawlableLocations = [];
        var coords = Board2.coordsFromNotation(location);
        if (coords.z === 0) {
          return crawlableLocations;
        }
        var locations = Board2.surroundingLocations(Board2.MOVEMENTS.DOWN(location));
        for (var i = 0; i < locations.length; i++) {
          var neighborLocation = locations[i];
          if (this.hive[neighborLocation]) {
            var neighborCoords = Board2.coordsFromNotation(neighborLocation);
            crawlableLocations.push(Board2.MOVEMENTS.UP(neighborLocation));
          }
        }
        return crawlableLocations;
      };
      Board2.prototype.droppableLocations = function(location) {
        var droppableLocations = [];
        if (Board2.coordsFromNotation(location).z === 0) {
        ...
        for (var i = 0; i < locations.length; i++) {
          ...
          var piece;
          do {
            var neighborLocation = Board2.MOVEMENTS.DOWN(neighborLocation);
            piece = this.hive[neighborLocation];
          } while (piece || Board2.coordsFromNotation(neighborLocation).z > 0);
          if (!piece) {
      ...
      Board2.prototype.hoppableLocations = function(location) {
        var hoppableLocations = [];
        var directions = ["N", "NE", "SE", "S", "SW", "NW"];
        for (var i = 0; i < directions.length; i++) {
          var moveFunction = Board2.MOVEMENTS[directions[i]];
      ...
      Board2.prototype.legalPiecePlacements = function(piece) {
        if (this.turn() === 1) {
          return [Board2.FIRST_LOCATION];
        }
        if (this.turn() === 2) {
          return [Board2.SECOND_LOCATION];
        }
        var legalPlacements = {};
        var pieces = this.piecesInPlayByColor(piece.color);
        for (var i = 0; i < pieces.length; i++) {
          var inPlayPiece = pieces[i];
          if (Board2.coordsFromNotation(inPlayPiece.location).z !== 0) {
            continue;
          }
          var surroundingLocations = Board2.surroundingLocations(inPlayPiece.location);
      ...
      Board2.prototype.legalPieceMovements = function(piece) {
        var legalMovements = [];
        piece.isMoving = true;
        var pieces = this.piecesInPlayByColor(piece.color);
      ...
      Board2.prototype.piecesInPlayOnGround = function() {
        return this.piecesInPlay().filter(function(piece) {
          return Board2.coordsFromNotation(piece.location).z === 0;
        });
      };
      Board2.prototype.piecesInPlay = function() {
        var whitePieces = this.piecesInPlayByColor(Board2.PLAYER_WHITE);
        var blackPieces = this.piecesInPlayByColor(Board2.PLAYER_BLACK);
        return whitePieces.concat(blackPieces);
      };
      Board2.prototype.piecesInPlayByColor = function(color) {
        return this.pieces[color].filter(function(piece) {
          return piece.isInPlay && !piece.isMoving;
        });
      };
      Board2.prototype.piecesNotInPlayByColor = function(color) {
        return this.pieces[color].filter(function(piece) {
          return !piece.isInPlay;
        });
      };
      Board2.prototype.validate = function(notation, skipMovment, flushErrors) {
        var valid = true;
      ...
      Board2.prototype.validateMovementAfterQueen = function(notation) {
        var moveType = Board2.moveTypeFromNotation(notation);
        if (moveType === "p") {
          return true;
        }
        var color = Board2.colorFromNotation(notation);
      ...
      Board2.prototype.validateMovement = function(notation) {
        var valid;
        var piece = this.findPieceFromNotation(notation);
        var moveType = Board2.moveTypeFromNotation(notation);
        var location = Board2.keyFromNotation(notation);
        if (moveType === "m") {
      ...
      Board2.prototype.validateColorTurnOrder = function(notation) {
        var color = Board2.colorFromNotation(notation);
      ...
      Board2.prototype.validateQueenPlaced = function(notation) {
        var turn = this.turn();
        var color = Board2.colorFromNotation(notation);
        var piece = this.findPieceFromNotation(notation);
        var valid = true;
        if (turn === 7 && color === Board2.PLAYER_WHITE || turn === 8 && color === Board2.PLAYER_BLACK) {
          if (piece.type !== "QUEEN") {
      ...
      Board2.prototype.validateConnected = function(notation) {
        var valid = true;
        var moveType = Board2.moveTypeFromNotation(notation);
        if (moveType === "m") {
          var piece = this.findPieceFromNotation(notation);
          ...
          var coords = Board2.coordsFromNotation(startingPiece.location);
          var visited = {};
      ...
      Board2.prototype.checkGameover = function() {
        if (this.quietMode) return;
        var _this = this;
        var queens = [Board2.PLAYER_WHITE, Board2.PLAYER_BLACK].map(function(color) {
      ...
      Board2.prototype.movement = function(notation) {
        var piece = this.findPieceFromNotation(notation);
        if (piece.location) {
          delete this.hive[piece.location];
        }
        this.hive[Board2.keyFromNotation(notation)] = piece;
        piece.prevLocations.push(piece.location);
        piece.location = Board2.keyFromNotation(notation);
        piece.isInPlay = true;
        this.broadcast("move", {
          turn: this.turn(),
          notation,
      ...
      Board2.prototype.rejectMovment = function(notation) {
        var piece = this.findPieceFromNotation(notation);
      ...
      Board2.prototype.revertLast = function() {
        var notation = this.moves.pop();
        var moveType = Board2.moveTypeFromNotation(notation);
        var key = Board2.keyFromNotation(notation);
      ...
      Board2.prototype.findPieceFromNotation = function(notation) {
        var color = Board2.colorFromNotation(notation);
        var pieceType = Board2.typeFromNotation(notation);
        var pieceTypeId = Board2.typeIdFromNotation(notation);
        return this.findPiece(color, pieceType, pieceTypeId);
      };
      Board2.prototype.findPiece = function(color, pieceType, pieceTypeId) {
        return this.pieces[color].filter(function(piece) {
          return piece.color === color && piece.type === pieceType && piece.typeId === parseInt(pieceTypeId);
        })[0];
      };
      Board2.prototype.hasQueenBeenPlayed = function(color) {
        return !!this.pieces[color].filter(function(piece) {
          return piece.type === "QUEEN" && piece.isInPlay;
        })[0];
      };
      Board2.prototype.processQueue = function(flushErrors) {
        if (this.isGameover) {
      ...
      Board2.prototype.on = function(eventName, cb) {
        this.listeners[eventName].push(cb);
      };
      Board2.prototype.broadcast = function(eventName, message) {
        if (this.quietMode) return;
        var _this = this;
      ...
      Board2.createPieces = function(color) {
        var pieces = [];
        Board2.pieceSet().forEach(function(piece, i) {
          pieces.push(new Board2.Piece({ color, type: piece, typeId: i + 1 }));
        });
        return pieces;
      };
      Board2.shallowHashClone = function(hash) {
        var clone = {};
      ...
      Board2.surroundingLocations = function(location) {
        var locations = [];
        ["N", "NE", "SE", "S", "SW", "NW"].forEach(function(direction) {
          var moveFn = Board2.MOVEMENTS[direction];
      ...
      Board2.MOVEMENTS = {
        N: function(location) {
          var coords = Board2.coordsFromNotation(location);
          return Board2.keyFromCoords(coords.x, coords.y + 2, coords.z);
        },
        NE: function(location) {
          var coords = Board2.coordsFromNotation(location);
          return Board2.keyFromCoords(coords.x + 1, coords.y + 1, coords.z);
        },
        ...
        UP: function(location) {
          var coords = Board2.coordsFromNotation(location);
          return Board2.keyFromCoords(coords.x, coords.y, coords.z + 1);
        },
      ...
      Board2.buildNotation = function(color, moveType, pieceType, pieceTypeId, x, y, z) {
        return color + ":" + moveType + ":" + pieceType + ":" + pieceTypeId + ":" + x + ":" + y + ":" + z;
      };
      Board2.typeFromNotation = function(notation) {
      ...
      Board2.typeIdFromNotation = function(notation) {
        if (notation.length > 1) {
          notation = notation.split(":")[2];
        }
        return notation.split("_")[1];
      };
      Board2.notationFromType = function(type, typeId) {
        switch (type) {
          case "SPIDER":
            return "s_" + typeId;
          case "BEETLE":
      ...
      Board2.notationFromColor = function(color) {
        return color === "WHITE" ? "w" : "b";
      };
      Board2.moveTypeFromNotation = function(notation) {
        return notation.split(":")[1];
      };
      Board2.colorFromNotation = function(notation) {
        if (notation.length > 1) {
      ...
      Board2.coordsFromNotation = function(notation) {
        var parts = Board2.keyPartsFromNotation(notation);
        return { x: parseInt(parts[0]), y: parseInt(parts[1]), z: parseInt(parts[2]) };
      };
      Board2.keyFromNotation = function(notation) {
        var parts = Board2.keyPartsFromNotation(notation);
        return parts.join(":");
      };
      Board2.keyPartsFromNotation = function(notation) {
      ...
      Board2.keyFromCoords = function(x, y, z) {
        return x + ":" + y + ":" + z;
      };
      Board2.randomColor = function() {
        return [Board2.PLAYER_WHITE, Board2.PLAYER_BLACK][Math.floor(Math.random() * 2)];
      };
      Board2.Piece = function(attrs) {
        this.isInPlay = false;
        this.isMoving = false;
  ...
  var require_ai = __commonJS({
    "lib/ai.js"(exports, module) {
      var Board2 = require_board();
      var evalCnt = 0;
      function AI2(board2) {
        this.board = board2;
      }
      AI2.prototype.allPossiblePlacements = function(color) {
        var allPlacments = [];
        var pieces = this.board.piecesNotInPlayByColor(color);
        var colorNotation = Board2.notationFromColor(color);
        for (var i = 0; i < pieces.length; i++) {
          var piece = pieces[i];
          var pieceTypeNotation = Board2.notationFromType(piece.type, piece.typeId);
      ...
      AI2.prototype.allPossibleMovements = function(color) {
        var allMovements = [];
      ...
      AI2.prototype.allPossibleMoves = function(color) {
        return AI2.shuffle(this.allPossiblePlacements(color).concat(this.allPossibleMovements(color)));
      };
      AI2.prototype.surroundingQueenCnt = function(color) {
      ...
      AI2.prototype.evaluatePosition = function() {
      ...
      AI2.prototype.bestMove = function(depth) {
        evalCnt = 0;
        this.maximizingColor = this.board.whoseTurn();
        this.minimizingColor = AI2.toggleColor(this.maximizingColor);
      ...
      AI2.prototype.minimax = function(depth, maximizing, alpha, beta, notation) {
        if (notation) {
      ...
      AI2.toggleColor = function(color) {
        return color === "BLACK" ? "WHITE" : "BLACK";
      };
      AI2.shuffle = function(o) {
  ...
  // app/assets/javascripts/workers/ai-worker.js
